...
function themeStyles(){
    ...
    wp_enqueue_style('ss-social', get_template_directory_uri(). '/css/ss-social.css');
    if(is_page('Home')){
...
wp_enqueue_script('ss-social-script', get_template_directory_uri(). '/js/ss-social.js','','',true);
